...
class FS28DemoActivity : AppCompatActivity() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*  if (!mIn)
            mRadioOut.setChecked(true);*/mButtonOpen?.setOnClickListener { v: View? ->
            if (mStop) {
                if (!mIn) {
        ...
        mButtonSave?.setOnClickListener(View.OnClickListener { v: View? -> SaveImage() })
        mRadioIn?.setOnClickListener(View.OnClickListener { v: View? -> mIn = true })
        mRadioOut?.setOnClickListener(View.OnClickListener { v: View? -> mIn = false })
    }
        ...
        override fun handleMessage(msg: Message) {
            when (msg.what) {
                ...
                MESSAGE_SHOW_IMAGE -> {
                    ...
                    if (mReceivedDataType == BluetoothDataService.DATA_TYPE_WSQIMAGE || mReceivedDataType == BluetoothDataService.DATA_TYPE_RAWIMAGE) ShowBitmap() else mFingerImage!!.setImageBitmap(
                        null
                    )
    ...
    public override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        when (requestCode) {
            ...
            REQUEST_FILE_FORMAT -> if (resultCode == RESULT_OK) {
                // Get the file format
                val extraString =
    ...
    companion object {
         ...
         */
        // Debugging
        private const val TAG = "FS28Demo_V3.1"
